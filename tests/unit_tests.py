...
class Tests(unittest.TestCase):
    ...
    def create_closedSet_test(self):
        map_40 = load_map_40()
    ...
    def get_current_node_test(self):
        map_40 = load_map_40()
        planner = PathPlanner(map_40, 37, 14)
    ...
    def get_tentative_gScore_test(self):
        map_40 = load_map_40()
        planner = PathPlanner(map_40, 5, 34)
    ...
    def heuristic_cost_estimate_test(self):
        map_40 = load_map_40()
        planner = PathPlanner(map_40, 5, 34)
    ...
    def calculate_fScore_test(self):
        map_40 = load_map_40()
        planner = PathPlanner(map_40, 5, 34)
    ...
    def record_best_path_to_test(self):
        map_40 = load_map_40()
        planner = PathPlanner(map_40, 5, 34)
        planner.gScore = {5: 1, 16: 3, 14: 3}
